...
function parseBlocks(input: string): ASTNode[] {
	const nodes: ASTNode[] = [];
	let i = 0;
 ...
 */
function parseInlineContent(input: string): ASTNode[] {
	const nodes: ASTNode[] = [];
	let remaining = input;
 ...
 */
function parseAttributes(attrStr: string, attrs: Record<string, any>): void {
